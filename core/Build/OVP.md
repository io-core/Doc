...
`  PROCEDURE IdentList(class: INTEGER; VAR first: ORB.Object);` [(source)](https://github.com/io-core/Build/blob/main/OVP.Mod#L755)
...
`  PROCEDURE Import;` [(source)](https://github.com/io-core/Build/blob/main/OVP.Mod#L1095)
