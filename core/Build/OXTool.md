...
`  PROCEDURE OpenViewer(T: Texts.Text; title: ARRAY OF CHAR);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L38)


`  PROCEDURE Clear*;  (*used to clear output*)` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L47)


`  PROCEDURE Recall*;` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L52)


`  PROCEDURE Read(VAR R: Files.Rider; VAR n: INTEGER);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L60)


`  PROCEDURE ArchFromExt(VAR s: ARRAY OF CHAR):INTEGER;` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L66)


`  PROCEDURE ReadType(VAR R: Files.Rider);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L83)

## ---------- Command Invocation
---
**Option** checks if a new symbol file may be generated.

`  PROCEDURE Option(VAR S: Texts.Scanner):INTEGER;` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L137)


`  PROCEDURE DecSym*;  (*decode symbol file*)` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L151)


`   PROCEDURE WriteHexBytes (x: LONGINT);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L192)


`   PROCEDURE HighNib(b: BYTE): CHAR;` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L206)


`   PROCEDURE LowNib(b: BYTE): CHAR;` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L214)


`  PROCEDURE Sync(VAR R: Files.Rider);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L222)


`  PROCEDURE Write(VAR R: Files.Rider; x: INTEGER);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L227)


`  PROCEDURE decodeSection(VAR R: Files.Rider; VAR F: Files.File; VAR n,s,x: INTEGER);` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L231)


`  PROCEDURE DecBin*;   (*decode bare metal binary file*)` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L254)


`  PROCEDURE DecObj*;   (*decode object file*)` [(source)](https://github.com/io-core/Build/blob/main/OXTool.Mod#L278)
