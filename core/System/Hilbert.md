...
## [MODULE Hilbert](https://github.com/io-core/System/blob/main/Hilbert.Mod)
...
`  PROCEDURE E;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L9)


`  PROCEDURE N;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L13)


`  PROCEDURE W;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L17)


`  PROCEDURE S;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L21)


`  PROCEDURE HA(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L25)


`  PROCEDURE HB(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L30)


`  PROCEDURE HC(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L35)


`  PROCEDURE HD(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L40)


`  PROCEDURE DrawHilbert(F: Display.Frame);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L45)


`  PROCEDURE Handler(F: Display.Frame; VAR M: Display.FrameMsg);` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L58)


`  PROCEDURE New(): Display.Frame;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L74)


`  PROCEDURE Draw*;` [(source)](https://github.com/io-core/System/blob/main/Hilbert.Mod#L79)
