...
## [MODULE Sierpinski](https://github.com/io-core/System/blob/main/Sierpinski.Mod)
...
`  PROCEDURE E;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L9)


`  PROCEDURE N;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L13)


`  PROCEDURE W;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L17)


`  PROCEDURE S;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L21)


`  PROCEDURE NE;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L25)


`  PROCEDURE NW;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L31)


`  PROCEDURE SW;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L37)


`  PROCEDURE SE;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L43)


`  PROCEDURE SA(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L49)


`  PROCEDURE SB(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L54)


`  PROCEDURE SC(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L59)


`  PROCEDURE SD(i: INTEGER);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L64)


`  PROCEDURE DrawSierpinski(F: Display.Frame);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L69)


`  PROCEDURE Handler(F: Display.Frame; VAR M: Display.FrameMsg);` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L83)


`  PROCEDURE New(): Display.Frame;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L99)


`  PROCEDURE Draw*;` [(source)](https://github.com/io-core/System/blob/main/Sierpinski.Mod#L104)
