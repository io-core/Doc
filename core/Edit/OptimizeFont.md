...
## [MODULE OptimizeFont](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod)
 ...
 FontFileId = 0DBH;
  ...
  BEGIN ww := (w + 7) DIV 8;
    ...
    WHILE i > 0 DO (* trim left *)
      empty := TRUE; j := h - 1;
      WHILE empty & (j >= 0) DO
        empty := (glyph[j * ww] = 0); DEC(j);
      END;
      IF empty THEN
        DEC(w); INC(x); carry := FALSE;
        FOR j := ww * h - 1 TO 0 DO
...
`  PROCEDURE ReadInt16(VAR R: Files.Rider; VAR v: INTEGER);` [(source)](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod#L6)


`  PROCEDURE WriteInt16(VAR R: Files.Rider; v: INTEGER);` [(source)](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod#L11)


`  PROCEDURE CopyBytes(VAR RR, RW: Files.Rider; count: INTEGER);` [(source)](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod#L15)


`  PROCEDURE OptimizeGlyph(VAR glyph: ARRAY OF BYTE; VAR x, y, w, h: INTEGER);` [(source)](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod#L24)


`  PROCEDURE Optimize*;` [(source)](https://github.com/io-core/Edit/blob/main/OptimizeFont.Mod#L102)
